...
namespace PhotoalbumMvcPL.Infrastructure
{
    public class CaptchaImage : IDisposable
    {
        ...
        private void GenerateImage()
        {
            ...
            float v = 3F;//degree of distortion (2F, 3F, 4F).
            PointF[] points =
            {
            ...
            // Draw the text.
            hatchBrush = new HatchBrush(HatchStyle.LargeConfetti, Color.LightGray, Color.DarkOrange);//Texture and color of numbers
            ...
            for (int i = 0; i < (int)(rect.Width * rect.Height / 30F); i++)
            {
                ...
                int w = random.Next(m / 20);//the less number the more horizontal noise
                int h = random.Next(m / 50);//the less number the more vertical noise
